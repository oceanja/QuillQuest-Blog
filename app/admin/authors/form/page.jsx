        ...
        <main className="w-full p-6 flex flex-col gap-3">
            ...
            <section className="flex justify-center">
                <form
                    ...
                    className="flex flex-col gap-2 bg-blue-50 rounded-xl p-7 w-full max-w-lg"
                >
                    ...
                    {data?.photoURL && (
                        <div>
                            <img className="h-40 w-full object-cover" src={data?.photoURL} alt="" />
                        </div>
                    )}
                    {image && (
                        <div>
                            <img className="h-40 w-full object-cover" src={URL.createObjectURL(image)} alt="" />
                        </div>
                    )}
                    <div className="flex flex-col gap-2">
