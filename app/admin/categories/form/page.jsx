  ...
  return (
    <main className="w-full p-4 md:p-6 flex flex-col gap-4 md:gap-6">
      <div className="flex flex-col md:flex-row gap-4 md:gap-5 items-center">
        {updateCategoryId ? (
          <div className="flex">
            <h3 className="text-white bg-purple-300 px-4 py-2 rounded-full text-xs font-bold">Update</h3>
          </div>
        ) : (
          <div className="flex">
        ...
        <h1 className="font-bold text-center md:text-left">Category | Form</h1>
      </div>
      <section className="flex justify-center">
        <form
          ...
          className="flex flex-col gap-4 bg-blue-50 rounded-xl p-6 md:p-7 w-full max-w-md"
        >
          ...
          {data?.iconURL && (
            <div className="flex justify-center">
              <img className="h-40 object-cover rounded-md" src={data?.iconURL} alt="" />
            </div>
          )}
          {image && (
            <div className="flex justify-center">
              <img className="h-40 object-cover rounded-md" src={URL.createObjectURL(image)} alt="" />
            </div>
          )}
          <div className="flex flex-col gap-2">
